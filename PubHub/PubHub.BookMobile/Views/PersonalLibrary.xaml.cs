...
public partial class PersonalLibrary : ContentPage
{
    private readonly PersonalLibraryViewModel _viewModel;

    public PersonalLibrary(PersonalLibraryViewModel viewModel)
    {
        InitializeComponent();
